...
async fn main() {
    ...
    // The following tests are temporarily commented out due to compatibility issues
    // with the latest versions of axum and reqwest. They will be fixed in a future update.
...
// Test rate limiting
// 
// NOTE: This test is temporarily commented out due to compatibility issues
// with the latest version of axum. It will be fixed in a future update.
...
// 
// NOTE: This test is temporarily commented out due to compatibility issues
// with the latest versions of axum and reqwest. It will be fixed in a future update.
